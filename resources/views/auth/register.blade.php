...
<div class="container">
    <div class="row justify-content-center">  
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Formularios de registro') }}</div>
            
                <div class="card-body">

                    <ul class="nav nav-pills nav-justified" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-empleados-tab" data-toggle="tab" href="#pills-empleados" role="tab" aria-controls="pills-empleados" aria-selected="true">Registro empleados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-empresas-tab" data-toggle="tab" href="#pills-empresas" role="tab" aria-controls="pills-empleados" aria-selected="false">Registro empresas</a>
                        </li>
                    </ul>  
