        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/nominaciones/.$nominaciones->id') }}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="clienteVendedor" type="text" class="form-control @error('clienteVendedor') is-invalid @enderror"
                                    name="clienteVendedor" value="{{ old('clienteVendedor', $nominaciones->clienteVendedor) }}" required autocomplete="clienteVendedor">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="clienteComprador" type="text" class="form-control @error('clienteComprador') is-invalid @enderror"
                                    name="clienteComprador" value="{{ old('clienteComprador', $nominaciones->clienteComprador) }}" required autocomplete="clienteComprador">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="numContrato" type="text" class="form-control @error('numContrato') is-invalid @enderror"
                                    name="numContrato" value="{{ old('numContrato', $nominaciones->numContrato) }}" required autocomplete="numContrato">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="producto" type="text" class="form-control @error('producto') is-invalid @enderror"
                                    name="producto" value="{{ old('producto', $nominaciones->producto) }}" required autocomplete="producto">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="eta" type="text" class="form-control @error('eta') is-invalid @enderror"
                                    name="eta" value="{{ old('eta', $nominaciones->eta) }}" required autocomplete="eta">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="cutOff" type="text" class="form-control @error('cutOff') is-invalid @enderror"
                                    name="cutOff" value="{{ old('cutOff', $nominaciones->cutOff) }}" required autocomplete="cutOff">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="naviera" type="text" class="form-control @error('naviera') is-invalid @enderror"
                                    name="naviera" value="{{ old('naviera', $nominaciones->naviera) }}" required autocomplete="naviera">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="motonave" type="text" class="form-control @error('motonave') is-invalid @enderror"
                                    name="motonave" value="{{ old('motonave', $nominaciones->motonave) }}" required autocomplete="motonave">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="viaje" type="text" class="form-control @error('viaje') is-invalid @enderror"
                                    name="viaje" value="{{ old('viaje', $nominaciones->viaje) }}" required autocomplete="viaje">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="booking" type="text" class="form-control @error('booking') is-invalid @enderror"
                                    name="booking" value="{{ old('booking', $nominaciones->booking) }}" required autocomplete="booking">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="puerto" type="text" class="form-control @error('puerto') is-invalid @enderror"
                                    name="puerto" value="{{ old('puerto, $nominaciones->puerto') }}" required autocomplete="puerto">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input id="numContainer" type="text" class="form-control @error('numContainer') is-invalid @enderror"
                                    name="numContainer" value="{{ old('numContainer', $nominaciones->numContainer) }}" required autocomplete="numContainer">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input id="tmContainer" type="text" class="form-control @error('tmContainer') is-invalid @enderror"
                                    name="tmContainer" value="{{ old('tmContainer', $nominaciones->tmContainer) }}" required autocomplete="tmContainer">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="unidadesContainer" type="text" class="form-control @error('unidadesContainer') is-invalid @enderror"
                                    name="unidadesContainer" value="{{ old('unidadesContainer', $nominaciones->unidadesContainer) }}" required autocomplete="unidadesContainer">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="toneladas" type="text" class="form-control @error('toneladas') is-invalid @enderror"
                                    name="toneladas" value="{{ old('toneladas', $nominaciones->toneladas) }}" required autocomplete="toneladas">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="supervision" type="text" class="form-control @error('supervision') is-invalid @enderror"
                                    name="supervision" value="{{ old('supervision', $nominaciones->supervision) }}" required autocomplete="supervision">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="tipoContainer" type="text" class="form-control @error('tipoContainer') is-invalid @enderror"
                                    name="tipoContainer" value="{{ old('tipoContainer', $nominaciones->tipoContainer) }}" required autocomplete="tipoContainer">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="instrucciones1" class="form-control @error('instrucciones1') is-invalid @enderror"
                                name="instrucciones1" value="{{ old('instrucciones1', $nominaciones->instrucciones1) }}" rows="2" autocomplete="instrucciones1"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="instrucciones2" class="form-control @error('instrucciones2') is-invalid @enderror"
                                name="instrucciones2" value="{{ old('instrucciones2', $nominaciones->instrucciones2) }}" rows="2" autocomplete="instrucciones2"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="instrucciones3" class="form-control @error('instrucciones3') is-invalid @enderror"
                                name="instrucciones3" value="{{ old('instrucciones3', $nominaciones->instrucciones3) }}" rows="2" autocomplete="instrucciones3"></textarea>
